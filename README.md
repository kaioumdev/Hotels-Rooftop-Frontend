...
3.  **Configure environment variables:**
    ...
    *   The base URL for API requests is set in `redux/features/blogs/blogsApi.js`, `redux/features/auth/authApi.js` and `redux/features/comments/commentApi.js` (currently `http://localhost:5005/api/`).  Update these if your backend is running on a different address.
...
4.  **Start the development server:**
    ...
    This will start the application in development mode, typically on `http://localhost:5005`.
